<div class="auth-page">
	<div class="auth-card">
		...
		<p class="auth-card__subtitle">Создайте аккаунт и получите 7 дней бесплатного просмотра</p>
		<form method="post" class="auth-form">
			...
			<div class="form-group">
				...
				<input type="password" name="password1" id="password1" placeholder="Минимум 6 символов" required>
			</div>
			<div class="form-group">
